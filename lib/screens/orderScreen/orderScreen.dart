...
import 'package:delivery_box/screens/orderScreen/widgets/bottomSheet/bottomSheet.dart';
import 'package:delivery_box/screens/orderScreen/widgets/orderServiceCard.dart';
import 'package:delivery_box/screens/orderScreen/widgets/reviewCard.dart';
          ...
          children: [
                              ...
                              children: [
                                InkWell(
                                  onTap: () {
                                    ...
                                    TastingBottomSheet.show(context);
                                  },
                                  child: Text(
                                    'View Menu',
                                    style: TextStyle(
            ...
            SizedBox(
              ...
              child: ListView(
                scrollDirection: Axis.horizontal,
                children: [
                  ReviewCard(screenWidth: screenWidth, screenHeight: screenHeight, name: 'Abhishek C', service: 'Delivery Box', rating: '5.0', imagePath: 'assets/images/customer1.jpg'),
                  SizedBox(width: screenWidth * 0.03),
                  ReviewCard(screenWidth: screenWidth, screenHeight: screenHeight, name: 'Jasmine T', service: 'Delivery Box', rating: '4.8', imagePath: 'assets/images/customer2.jpg'),
                  SizedBox(width: screenWidth * 0.03),
                  ReviewCard(screenWidth: screenWidth, screenHeight: screenHeight, name: 'Abhishek C', service: 'Delivery Box', rating: '5.0', imagePath: 'assets/images/customer1.jpg'),
                  SizedBox(width: screenWidth * 0.03),
                  ReviewCard(screenWidth: screenWidth, screenHeight: screenHeight, name: 'Jasmine T', service: 'Delivery Box', rating: '4.8', imagePath: 'assets/images/customer2.jpg')
